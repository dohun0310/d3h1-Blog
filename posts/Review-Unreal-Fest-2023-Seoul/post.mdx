...
![Interpretation Receiver](./Interpretation-Receiver.jpg)

아 그리고 선착순 300명 안에 들으면 언리얼 야광 키링을 준다고 해서 9시 30분 입장인데 8시 23분부터 가서 기다리고 있었습니다.

![Entrance Time Shot](./Entrance-Time-Shot.jpg)
...
![Opening Remarks](./Opening-Remarks.jpg)
...
![Review-Unreal-Fest-2023-Seoul-Nanite-Lumen](./Nanite-Lumen.jpg)
...
![Character & Animation Improvements](./Character-Animation-Improvements.jpg)

멀티 프로세스 쿡이 추가되며 개발자가 콘텐츠를 플랫폼별 포맷으로 변환할 때 추가 CPU 및 메모리 리소스를 활용할 수 있어서 로컬에서 시간 단축이 많이 된다고 합니다.

![Development Process Improvements](./Development-Process-Improvements.jpg)
...
![Unreal Engine](./Unreal-Engine-5.3-Update.jpg)
...
![Panel Discussion](./Panel-Discussion.jpg)
...
![Jack Porter](./Jack-Porter.jpg)

언리얼 엔진은 크로스 플랫폼 개발과 확장성 향상, 호환성 개선, 메모리 사용량을 줄이는 여러 최적화 작업을 진행 중이라고 합니다.

![Unreal Engine Mobile Developmnet Focus](./Unreal-Engine-Mobile-Development-Focus.jpg)

앞에서 살짝 언급됐던 것처럼 iOS 앱을 Mac에서 시뮬레이팅 가능하다고 합니다. 대신에 Apple Silicon 칩이 탑재된 제품에서만요.

![iOS Simulator](./iOS-Simulator.jpg)

또한 Apple이 최근 더 많은 가상 램을 사용할 수 있게 되면서 그것에 대한 지원도 추가 되었다고 합니다.

![iOS Memory Entitlements](./iOS-Memory-Entitlements.jpg)

그리고 iOS 앱 빌드를 할 수 있는 여러 방법이 소개되었는데요. 이건 너무 머리 아파서 대충 사진만 첨부하겠습니다. 가장 좋은 방법은 그냥 Apple이 Xcode를 거치지 않고 앱 빌드를 할 수 있게 해줬으면 좋겠어요.

![iOS PC Workflows A, B, C](./iOS-PC-Workflows-ABC.jpg)
![iOS PC Workflows B + C](./iOS-PC-Workflows-B+C.jpg)

또한 Xcode에서 iOS 앱 디버깅 하기가 더 쉬워졌다고 하고요.

![iOS Easier Debug](./iOS-Easier-Debug.jpg)
![iOS Easier Debug In Windows](./iOS-Easier-Debug-In-Windows.jpg)

다음부터는 안드로이드 관련 이야기가 나왔습니다. 먼저 안드로이드 SDK와 AGDE가 업데이트 되었다고 합니다.

![Android SDK And AGDE Updates](./Android-SDK-And-AGDE-Updates.jpg)

또한 구글 플레이 결제 라이브러리도 업데이트 되었고요.

![Google Play Billing Library Update](./Google-Play-Billing-Library-Update.jpg)

스토리지 범위 지정과 AFS에 관한 이야기도 있었습니다.

![Android Scoped Storage And AFS 1](./Android-Scoped-Storage-And-AFS-1.jpg)
![Android Scoped Storage And AFS 2](./Android-Scoped-Storage-And-AFS-2.jpg)
![Android Scoped Storage And AFS 3](./Android-Scoped-Storage-And-AFS-3.jpg)

짜잘한 기타 업데이트 내용도 있었으니 확인해보시고요.

![Android Miscellaneous Updates](./Android-Miscellaneous-Updates.jpg)

아래에는 여러가지 안드로이드 개발자들을 위한 팁도 소개가 되어있습니다.

![Android Developer Tip 1](./Android-Developer-Tip-1.jpg)
![Android Developer Tip 2](./Android-Developer-Tip-2.jpg)
![Android Developer Tip 3](./Android-Developer-Tip-3.jpg)

모바일 렌더링 업데이트를 언급하며 가장 먼저 PC와 모바일의 렌더링 차이에 대해 언급을 하였습니다.

![Desktop Mobile Rendering Differences](./Desktop-Mobile-Rendering-Differences.jpg)

셰이더 파이프라인 캐시와 PSO 캐시의 문제점을 언급했고 PSO 캐시의 개선점도 말했습니다.

![Shader Pipline Cache PSO Caching](./Shader-Pipline-Cache-PSO-Caching.jpg)
![Runtime PSO caching](./Runtime-PSO-Caching.jpg)

퀄리티 부분의 자잘한 개선점도 언급되었습니다.

![Miscellaneous Quality Improvements](./Miscellaneous-Quality-Improvements.jpg)

또한 안드로이드 레이트레이싱을 위한 요구사항도 공개되었고요.

![Future Android Ray Rracing](./Future-Android-Ray-Rracing.jpg)
...
![Physics Assets 1](./Physics-Assets-1.jpg)
![Physics Assets 2](./Physics-Assets-2.jpg)
![Physics Assets 3](./Physics-Assets-3.jpg)
![Physics Assets 4](./Physics-Assets-4.jpg)
![Physics Assets 5](./Physics-Assets-5.jpg)
![Physics Assets 6](./Physics-Assets-6.jpg)
![Physics Assets 7](./Physics-Assets-7.jpg)
![Physics Assets 8](./Physics-Assets-8.jpg)
![Physics Assets 9](./Physics-Assets-9.jpg)
![Physics Assets 10](./Physics-Assets-10.jpg)

그 후 리지드 바디에 관한 내용이 발표되었고요.

![Rigid Body 1](./Rigid-Body-1.jpg)
![Rigid Body 2](./Rigid-Body-2.jpg)
![Rigid Body 3](./Rigid-Body-3.jpg)
![Rigid Body 4](./Rigid-Body-4.jpg)

또한 클로스용 모델링 가이드 등 많은 내용들이 발표되었습니다.

![Cloth Modeling Guide](./Cloth-Modeling-Guide-1.jpg)
![Cloth Modeling Guide](./Cloth-Modeling-Guide-2.jpg)
...
![Introducing MetaHuman Animator](./Introducting-MetaHuman-Animator.jpg)

필요한 사항은 아래와 같습니다. iPhone 12 이상인 이유는 iPhone 12 이상의 AP가 가장 메타휴먼 애니메이터를 제작하는데 가장 최소 사양이라고 생각한다고 한다네요.

![MetaHuman Animator Requirements](./MetaHuman-Animator-Requirements.jpg)

다양한 방식으로 캡처가 가능하다고 합니다.

![MetaHuman Animator Capture Methods](./MetaHuman-Animator-Capture-Methods.jpg)

또한 디바이스별 뎁스 비교를 에픽 게임즈에서 직접한 자료도 제시해주셨습니다. iPhone 12와 iPhone 14의 차이도 상당하네요.

![Comparing Depth by MetaHuman Animator Device](./Comparing-Depth-By-MetaHuman-Animator-Device.jpg)

캡처 가이드도 제시를 해주셨습니다. 어떤 자세를 취해야 하는지, 어떤 상황이여야하는지 구체적인 상황을 제시해 주셨습니다.

![MetaHuman Animator Capture Guide 1](./MetaHuman-Animator-Capture-Guide-1.jpg)
![MetaHuman Animator Capture Guide 2](./MetaHuman-Animator-Capture-Guide-2.jpg)
![MetaHuman Animator Capture Guide 3](./MetaHuman-Animator-Capture-Guide-3.jpg)

iPhone으로 캡처시의 워크플로도 알아볼 수 있었습니다.

![MetaHuman Animator iPhone Capture Workflows](./MetaHuman-Animator-iPhone-Capture-Workflows.jpg)
