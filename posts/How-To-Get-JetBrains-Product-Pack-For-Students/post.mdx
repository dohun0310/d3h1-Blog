...
![JetBrains Product Pack for Students School Email Submit](./School-Email-Submit.png)

이 네 가지 방법 중에서 저희는 `GitHub Student Developer Pack`을 받았으니 쉽고 간편하게 인증이 가능한 `GitHub`를 선택해 봅니다.

![JetBrains Product Pack for Students GitHub Authorize](./GitHub-Authorize.png)
...
![JetBrains Product Pack for Students GitHub Submit](./GitHub-Submit.png)
...
![JetBrains Product Pack for Students License](./Licence.png)
